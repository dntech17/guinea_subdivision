...
export const getRegionsAndCodes = () => (
  regions
 )

export const getRegions = () => (
   regions.map(data => (data.region))
  )

export const getRegionsCodes = () => (
    regions.map(data => (data.code))
  )
...
export const getPrefecturesAndCodes = () => (
    prefectures
   )

export const getPrefecturesCodes = () => (
    prefectures.map(data => (data.prefectureCode))
   )

export const getPrefectures = () => (
    prefectures.map(data => (data.prefecture))
   )

export const getPrefecturesAndCodesByRegionCode = regionCode => {
  let result = []
...
export const getPrefecturesByRegionCode = regionCode => {
  let result = []
  prefectures.map(data => {
    if (data.regionCode === regionCode) {
...
export const getPrefecturesByRegionName = regionName => {
...
export const getPrefectureNameByCode = prefectureCode => {
  let name = null
  prefectures.map(data => {
...
export const getPrefectureCodeByName = prefectureName => {
  let code = null
  prefectures.map(data => {
...
export const getSousprefecturesAndCodes = () => (
  sousprefectures
 )

export const getSousprefecturesCodes = () => (
  sousprefectures.map(data => (data.sousprefectureCode))
 )

export const getSousprefectures = () => (
  sousprefectures.map(data => (data.sousprefecture))
 )

export const getSousprefecturesAndCodesByPrefectureCode = prefectureCode => {
  let result = []
...
export const getSousprefecturesByPrefectureCode = prefectureCode => {
  let result = []
  sousprefectures.map(data => {
    if (data.prefectureCode === prefectureCode) {
...
export const getSousprefecturesAndCodesByPrefectureName = prefectureName => {
...
export const getSousprefecturesByPrefectureName = prefectureName => {
  let prefectureCode = getPrefectureCodeByName(prefectureName)
  let result = []
  sousprefectures.map(data => {
    if (data.prefectureCode === prefectureCode) {
...
export const getSousprefectureNameByCode = sousprefectureCode => {
  let name = null
  sousprefectures.map(data => {
...
export const getSousprefectureCodeByName = sousprefectureName => {
  let code = null
  prefectures.map(data => {
